...
|---|---:|---:|---:|---|
| admin | 65 | 8,952 | — | [docs/roles/admin.md](docs/roles/admin.md) |
...
Token figures were measured against the pre-65-tool catalog; treat them as lower bounds until re-measured.
